...
#' @description Reading from the csv file and storing the data frame in the variable named 'flights'
#' @export
catch_data <- function(){
...
#' @description Plotting AA departure and arrival delay to check if there is some sort of dependence, and as we can see as dep_delays increase, also arr_delays increase.
#' @export
lemmesee <- function(){
